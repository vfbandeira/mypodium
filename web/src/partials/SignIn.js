          ...
          <div className="row">
            <div className="col-6">
              <div className="signin-left-container">
                <img className="signin-img" src="/logo2.png" alt="MyPodium"/>
            ...
            <div className="col-6">
              <div className="signin-right-container">
                ...
                <p>MyPodium is built using <a target="_blank" rel="noopener noreferrer" href="https://blockstack.org/try-blockstack">Blockstack</a> infrastructure, allowing us to provide decentralized encrypted storage.</p>
